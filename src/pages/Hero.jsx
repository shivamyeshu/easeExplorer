...
// import EiRa from "../assets/ease.png";
  ...
  return (
    <div className="mt-10 pt-4 lg:px-0 px-8">
      <div className="flex mb-5 items-center justify-center mx-auto gap-3 w-40">
        <img
          className="border-2 border-[#2b5b88] h-25 w-18 rounded-full"
          src={logo2}
          alt="logo"
        />
      </div>
      <div className="lg:px-72 flex items-center flex-col text-center gap-8">
        <h2 className="lg:text-7xl text-4xl font-bold">
          <span className="text-[#332b6b]">{HERO.title}</span>
        </h2>
        ...
        <NavLink
          to={"/create-trip"}
          className="shadow-sm shadow-[#465461]  text-black lg:text-xl text-lg font-medium py-3 lg:px-10 px-6 rounded-full"
        >
          {HERO.buttonLable}
        </NavLink>
      </div>
